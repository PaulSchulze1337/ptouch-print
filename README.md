...
The tool was written for and tested with the PT-2430PC, but meanwhile is also used with others (see `ptouch-print --list-supported`) Maybe others work too (please report USB VID and PID so I can include support for further models, too).
...
Detailed compile and install instructions:
